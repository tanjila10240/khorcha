...
<div class="row">
    <div class="col-md-12">
        <div class="card mb-3">
          ...
          <div class="alert alert-danger text-center alert_error" role="alert">
            ...
            <table class="table table-bordered table-striped table-hover custom_table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="#" id="restore"data-bs-toggle="modal" data-bs-target="#restoreModal" data-id="{{$data->incate_id}}"> <i class="fas fa-recycle fs-5 text-success fw-bold mx-2"></i></a>
                     <a href="#" id="delete"data-bs-toggle="modal" data-bs-target="#deleteModal" data-id="{{$data->incate_id}}"> <i class="fas fa-trash fs-5 text-danger fw-bold"></i></a>
                  </td>
                </tr> 
                @endforeach
              </tbody> 
